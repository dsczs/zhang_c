...
./configure --prefix=/usr/local/nginx_windows --user=www --group=www --sbin-path=/usr/local/nginx_windows/sbin --with-http_stub_status_module --conf-path=/usr/local/nginx_windows/nginx.conf --pid-path=/usr/local/nginx_windows/nginx.pid --error-log-path=/usr/local/nginx_windows/nginx-error.log  --with-http_ssl_module --with-pcre=/home/lamp_linux/pcre-8.32 --with-zlib=/home/lamp_linux/zlib-1.2.8 --with-openssl=/home/lamp_linux/openssl-1.0.1r && make && make install
